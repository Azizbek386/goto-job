        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="job-thumb job-thumb-box">
                    ...
                    <div class="job-body">
                        <h4 class="job-title">
                            <a href="{{ route("job_listings") }}" class="job-title-link">Programmer</a>
                        </h4>
                        ...
                        <div class="d-flex align-items-center border-top pt-3">
                            ...
                            <a href="{{ route("job_listings") }}" class="custom-btn btn ms-auto">Apply now</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="job-thumb job-thumb-box">
                    ...
                    <div class="job-body">
                        <h4 class="job-title">
                            <a href="{{ route("job_listings") }}" class="job-title-link">HR Manager</a>
                        </h4>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="job-thumb job-thumb-box">
                    ...
                    <div class="job-body">
                        <h4 class="job-title">
                            <a href="{{ route("job_details") }}" class="job-title-link">Sales Representative</a>
                        </h4>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="job-thumb job-thumb-box">
                    <div class="job-image-box-wrap">
                        ...
                        <div class="job-image-box-wrap-info d-flex align-items-center">
                            <p class="mb-0">
                                <a href="{{ route("job_listings") }}" class="badge badge-level">Mid Level</a>
                            </p>

                            <p class="mb-0">
                                <a href="{{ route("job_listings") }}" class="badge">Full Time</a>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="job-body">
                        <h4 class="job-title">
                            <a href="{{ route("job_details") }}" class="job-title-link">Graphic Designer</a>
                        </h4>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="job-thumb job-thumb-box">
                    ...
                    <div class="job-body">
                        <h4 class="job-title">
                            <a href="{{ route("job_details") }}" class="job-title-link">Customer Support</a>
                        </h4>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="job-thumb job-thumb-box">
                    ...
                    <div class="job-body">
                        <h4 class="job-title">
                            <a href="{{ route("job_details") }}" class="job-title-link">Language Teacher</a>
                        </h4>
